...
public Plugin myinfo = {
	name		= "NCLiteRPG Long Jump 2",
	author		= "SenatoR",
	description	= "Skill Long Jump 2 for NCLiteRPG [SM RPG STYLE]",
	version		= VERSION,
	url			= ""
};
...
{
	NCLiteRPG_Configs RPG_Configs = NCLiteRPG_Configs(ThisSkillShortName..."2",CONFIG_SKILL);
