...
public Plugin myinfo = {
	name		= "NCLiteRPG Skill Ice Stab",
	author		= "SenatoR",
	description	= "Skill Ice Stab for NCLiteRPG",
	version		= VERSION
};
...
public void NCLiteRPG_OnRegisterSkills() { ThisSkillID = NCLiteRPG_RegSkill(ThisSkillShortName, 3, 20,10,true); }
