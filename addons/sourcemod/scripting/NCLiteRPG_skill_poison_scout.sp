...
public Plugin myinfo = {
	name		= "NCLiteRPG Poison scout",
	author		= "SenatoR",
	description	= "Skill poison scout for NCLiteRPG",
	version		= VERSION,
	url			= ""
};
...
public void OnMapStart() {
	...
	if(cfg_bEffects)
	{
		AddFileToDownloadsTable("particles/NCLiteRPG_poison.pcf");
		PrecacheParticle("particles/NCLiteRPG_poison.pcf");
...
void DealPoisonDamage(int victim,int attacker,int damage) { NCLiteRPG_DealDamage(victim, damage, attacker, DMG_POISON, "poison_scout"); }
